...
urlpatterns = [
    ...
    path('birthdays/<int:birthday_id>/assoc_gift/<int:gift_id>/', views.assoc_gift, name='assoc_gift'),
    path('birthdays/<int:birthday_id>/assoc_gift/<int:gift_id>/delete/', views.assoc_gift_delete, name='assoc_gift_delete'),
